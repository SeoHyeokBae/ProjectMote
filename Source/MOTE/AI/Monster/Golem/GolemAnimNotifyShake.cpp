...
#include "AI/Monster/Golem/GolemAnimNotifyShake.h"
...
void UGolemAnimNotifyShake::NotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
}
